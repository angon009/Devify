        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoadNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_AspNetUsers_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notifications_NotificationTypes_MessageTextId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageFor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductId = table.Column<int>(type: "int", nullable: true),
                    StoreId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2c5e174e-3b0e-446f-86af-483d56fd7210"), "637898739305320073", "Admin", "ADMIN" },
                    { new Guid("91a7d5bf-4a71-4330-b87d-ec8af2923ab2"), "637898739905320096", "Vendor", "VENDOR" },
                    { new Guid("dbac2676-792c-4ae5-a058-03b9127fb7d1"), "637898740505320105", "Customer", "CUSTOMER" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Birthdate", "ConcurrencyStamp", "CreatedAt", "Email", "EmailConfirmed", "FirstName", "Gender", "Image", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TimeZone", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("8e445865-a24d-4543-a6c6-9443d048cdb9"), 0, new DateTime(2022, 6, 3, 17, 25, 30, 525, DateTimeKind.Local).AddTicks(2901), "460c457a-d4ed-474e-8320-feac03f56062", new DateTime(2022, 6, 3, 17, 25, 30, 525, DateTimeKind.Local).AddTicks(2912), "admin@ecommerce.com", true, "Super Admin", "Male", null, "", true, null, "ADMIN@ECOMMERCE.COM", "ADMIN@ECOMMERCE.COM", "AQAAAAEAACcQAAAAEJxpfJbx4FAWLFq2RCfIQcEX1pN4+HrfJlEa2j3gDHeTRoxQ/leGDfFcf1A0pTibuw==", null, false, "80419bd5-339d-442a-8b0c-aff0733e75a5", null, false, "admin@ecommerce.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_MessageTextId",
                table: "Notifications",
