...
namespace ECommerce.Web.Data.Migrations
{
    ...
    [Migration("20220603232034_InitialCreate")]
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Users.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Birthdate = new DateTime(2022, 6, 4, 5, 20, 34, 57, DateTimeKind.Local).AddTicks(8078),
                            ConcurrencyStamp = "3b9ba265-ae62-4915-9d32-9e6e4692d26b",
                            CreatedAt = new DateTime(2022, 6, 4, 5, 20, 34, 57, DateTimeKind.Local).AddTicks(8089),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEATATi0wByJBPKW0+DeWEQKK9qLcQcdLbEuZp3I3pjyY1VZP4Fz4RUOW5qANMJ993A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "3fcbd600-878f-4880-938d-f03a45494161",
            ...
            modelBuilder.Entity("ECommerce.Core.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "637899168340644156",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = new Guid("45ba2dc2-6f91-4dc9-a0d4-3bda362245c4"),
                            ConcurrencyStamp = "637899168940644178",
                            Name = "Vendor",
                            NormalizedName = "VENDOR"
                        },
                        new
                        {
                            Id = new Guid("afd00ae2-d230-4ae6-90bf-35e63fbf3262"),
                            ConcurrencyStamp = "637899169540644197",
                            Name = "Customer",
